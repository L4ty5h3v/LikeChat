...
// FIX: Use correct action type "launch_frame" (not "launch_miniapp")
// and match the official Farcaster Mini Apps embed specification
const miniAppEmbed = JSON.stringify({
  ...
  button: {
    ...
    action: {
      type: "launch_frame",  // FIX: was "launch_miniapp" — must be "launch_frame"
      name: "Mrs. Crypto's Flirting Tips",
      url: APP_URL,
      splashImageUrl: `${APP_URL}/icon-heart.png`,
  ...
  return (
    <>
      <Head>
        ...
        {/* Farcaster Mini App embed meta tag — use fc:miniapp as primary */}
