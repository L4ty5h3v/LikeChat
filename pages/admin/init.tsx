      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-6">
          ...
          <p className="text-gray-600 mb-4">
            Эта страница позволяет инициализировать систему 30 начальными ссылками (по 10 для каждого типа активности: like, recast, comment).
          </p>
        ...
        <div className="bg-yellow-50 border-2 border-yellow-300 rounded-2xl p-6">
          ...
          <p className="text-yellow-700">
            Эта операция добавляет 30 начальных ссылок в систему (10 для like, 10 для recast, 10 для comment). 
